...
public class MenuGUI extends JFrame implements ActionListener
{
	...
	private String displayBill() {
		...
		totalAfterDiscount = calcAfterDiscount(currentOrder);
	...
	private void placeOrder() throws DuplicateIDException, CalculationError {
		if(!currentOrder.isEmpty()) {
			...
			int custId = customerList.addCustomer(toArrayList(currentOrder),totalBeforeDiscount,(float)calcAfterDiscount(currentOrder));
