...
public class TestItem {
	...
	public void testGetId() throws InvalidIdException { //makes sure that the new item is created 
		Item item1 = new Item("HOT012","White chocolate",2.5f,"HotDrink","Regular hot chocolate", 0);
	...
	public void testEquals() throws InvalidIdException {
		 Item item1 = new Item("HOT012","White chocolate",2.5f,"HotDrink","Regular hot chocolate", 0);
		 Item item2 =  new Item("HOT012","White chocolate",2.5f,"HotDrink","Regular hot chocolate", 0);
		 Item item3 =  new Item("HOT008","Reg Latte",2.5f,"HotDrink","Regular hot chocolate", 0);
    ...
    {
		try {
			Item item = new Item("CAT001","Candy",2.5f,"HotDrink","Regular white chocolate", 0); //the id does not begin with the right header
    ...
    {
		try {
			Item item = new Item("FOD001","",2.5f,"HotDrink","Regular white chocolate", 0); 
			fail("Invalid id supplied - should throw exception");  
		}
	...
	public  void invalidPrize() throws InvalidIdException {
		Item item = new Item("FOD001","Tuna sandwich",-3f,"Food","Tuna and salad on white bread", 0);
	}
